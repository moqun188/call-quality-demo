...
class DiarizationEngine {
  ...
  _detectRoles(utterances) {
    ...
    // 客服特征词（服务方常用语）
    // 优先级: 句式结构 > 单个关键词
    const agentPattern = /请问|欢迎致电|您好.*客服|帮您|为您|我帮您|您.*需要|工号|您.*方便|温馨提示|回访|跟进|为您.*办理|请问.*需要|核实|确认.*信息|您.*排在|祝.*宝宝|祝.*健康|再见$|做.*回访|给您.*做|这边是.*基金会|是.*的家长吗|是.*家长吗|您是.*吗/;
    // 客户特征词（需求方常用语）
    const custPattern = /我想|我要|咨询|投诉|多少钱|怎么回事|退货|退款|我的订单|你们.*什么|好的.*谢谢|什么时候|多久|有没有|怎么办|办了|医保|新农合|好好好|那.*那|是吧|嗯嗯|已经.*了|现在.*了|我.*这边|行行行|谢谢啊|对对对/;
